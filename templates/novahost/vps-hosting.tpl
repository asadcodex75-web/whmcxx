      ...
      <div class="hero-grid">
        <div>
          ...
          <div class="hero-actions">
            <a class="button primary" href="{$WEB_ROOT}/cart.php?a=add&amp;pid=4">Configure a VPS</a>
    ...
    <div class="container">
      ...
      <div class="cards-grid">
        <article class="card">
          ...
          <a class="button primary" href="{$WEB_ROOT}/cart.php?a=add&amp;pid=4">Deploy Build</a>
        </article>
        <article class="card">
          <h3>Grow</h3>
          ...
          <a class="button primary" href="{$WEB_ROOT}/cart.php?a=add&amp;pid=5">Deploy Grow</a>
        </article>
        <article class="card">
          <h3>Scale</h3>
          ...
          <a class="button primary" href="{$WEB_ROOT}/cart.php?a=add&amp;pid=6">Deploy Scale</a>
        </article>
      </div>
    </div>
  </section>
