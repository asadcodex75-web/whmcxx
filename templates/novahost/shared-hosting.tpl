...
{assign var="launchPid" value=$sharedPlanPids.launch|default:null}
{assign var="growthPid" value=$sharedPlanPids.growth|default:null}
{assign var="scalePid" value=$sharedPlanPids.scale|default:null}
        ...
        <div>
          ...
          <div class="hero-actions">
            <a
              ...
              href="{if $launchPid}{$WEB_ROOT}/cart.php?a=add&amp;pid={$launchPid}{elseif $sharedGroupGid}{$WEB_ROOT}/cart.php?a=view&amp;gid={$sharedGroupGid}{else}{$WEB_ROOT}/cart.php?a=view{/if}"
            >
              Launch Order Wizard
            </a>
    ...
    <div class="container">
      ...
      <div class="pricing-grid">
        ...
        <article class="plan popular">
          ...
          <a
            class="button primary"
            href="{if $growthPid}{$WEB_ROOT}/cart.php?a=add&amp;pid={$growthPid}{elseif $sharedGroupGid}{$WEB_ROOT}/cart.php?a=view&amp;gid={$sharedGroupGid}{else}{$WEB_ROOT}/cart.php?a=view{/if}"
          >
            Order Growth
          </a>
        </article>
        <article class="plan">
          ...
          <a
            class="button primary"
            href="{if $scalePid}{$WEB_ROOT}/cart.php?a=add&amp;pid={$scalePid}{elseif $sharedGroupGid}{$WEB_ROOT}/cart.php?a=view&amp;gid={$sharedGroupGid}{else}{$WEB_ROOT}/cart.php?a=view{/if}"
          >
            Order Scale
          </a>
        </article>
