...
{assign var="requestPid" value=$dedicatedPlanPids.request|default:null}
        ...
        <div>
          ...
          <div class="hero-actions">
            <a
              ...
              href="{if $requestPid}{$WEB_ROOT}/cart.php?a=add&amp;pid={$requestPid}{elseif $dedicatedGroupGid}{$WEB_ROOT}/cart.php?a=view&amp;gid={$dedicatedGroupGid}{else}{$WEB_ROOT}/cart.php?a=view{/if}"
            >
              Request a Server
            </a>
